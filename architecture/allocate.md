...
- **No lateral dependency on [Mind](mind.md).** `astro_mine.allocate.mind` registers the CP-SAT
  planner as a Mind tier, and used to import Mind to do it — a runtime lateral edge declared here
  under `conventions.md` §3.2. The direction was always correct dependency inversion (the plugin
