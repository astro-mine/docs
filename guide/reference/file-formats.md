...
- **`examples/` in a repository** — browsable on GitHub, present in a clone, absent from an
  installed wheel. `astro-mine-platform/examples/` holds **13 authored documents across 7 kinds** and is
  the main set.
...
```
astro-mine-platform/examples/assets/lunar-scout-rover.sadf.yaml
astro-mine-platform/examples/assets/neo-sep-carrier.sadf.yaml
```
...
```
astro-mine-platform/examples/objectives/lunar-polar-ice-prospecting.objective.yaml
```
...
```
astro-mine-platform/examples/mission/lunar-surface-single-phase.mission.yaml
astro-mine-platform/examples/mission/neo-sample-return-multiphase.mission.yaml
```
...
```
astro-mine-platform/examples/plan/standing-control.plan.yaml
astro-mine-platform/examples/plan/lunar-prospecting-contingent.plan.yaml
```
...
```
astro-mine-platform/examples/plugins/greedy-prospecting-baseline.manifest.yaml
astro-mine-platform/examples/plugins/lunar-terramechanics-engine.manifest.yaml
```
...
```
astro-mine-platform/examples/policy/minimal.policy-package.yaml
astro-mine-platform/examples/policy/greedy-prospecting-baseline.policy-package.yaml
```
...
```
astro-mine-platform/examples/run-provenance/minimal.run-provenance.yaml
astro-mine-platform/examples/run-provenance/full.run-provenance.yaml
```
...
```
astro-mine-platform/src/astro_mine/mind/reference/stacks/lunar_prospecting.yaml
...
```
astro-mine-platform/src/astro_mine/learn/reference/train_config.json
```
